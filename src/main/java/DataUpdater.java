...
public class DataUpdater {
    ...
    public List<Map<String, Object>> processUpdates(
        ...
        System.out.println("DataUpdater finished. Migrated rows count: " + migratedData.size());
        return migratedData;
    }
